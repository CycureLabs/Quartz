...
# All variables with names of all caps will be
# registered as a state option to SimStateOptions.

import string
from .sim_state_options import SimStateOptions

# DEBUG options: these options cause Quartz to set
# breakpoints in various places or raise exceptions
# when checks fail.
...
# This option controls whether registers are
# carried out by the analysis.
# Without this, statements are still analyzed,
# but the state is not updated.

DO_PUTS = "DO_PUTS"
DO_GETS = "DO_GETS"

# This option controls whether memory loads are
# carried out by the analysis.
# Without htis, statements are still analyzed,
# but the state is not updated.
DO_STORES = "DO_STORES"
DO_LOADS = "DO_LOADS"

# This option controls whether or not constraints
# are tracked in the analysis.
TRACK_CONSTRAINTS = "TRACK_CONSTRAINTS"

# This option causes constraints to be flushed at
# the beginning of every instruction.
INSTRUCTION_SCOPE_CONSTRAINTS = "INSTRUCTION_SCOPE_CONSTRAINTS"
BLOCK_SCOPE_CONSTRAINTS = "BLOCK_SCOPE_CONSTRAINTS"

# This option controls whether or not various entities
